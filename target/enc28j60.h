...
// ENC28J60 PHIE Register Bit Definitions
#define PHIE_PLNKIE		0x10
#define PHIE_PGEIE		0x02
...
/*
 * check the interrupt pin to see if a received packet is indicated
 */
int enc28j60_poll();
